...
class EnsureSnapshotLifetimeTagExistsCheck(BaseResourceCheck):
    def __init__(self) -> None:
        name = "Ensure snapshotlifetime tag exists. Valid Values are numbers from 0 to 30"
        id = "CCOE_AZ2_TAGS_1"
    ...
    def scan_resource_conf(self, conf):
        ...
        if tags and isinstance(tags, list):
            ...
            if tags and isinstance(tags, dict):
                ...
                snapshotlifetime = tags.get("snapshotlifetime")
                if snapshotlifetime is not None and int(snapshotlifetime) <= 30:
