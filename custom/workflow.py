...
class EnsureResourcesLocation(BaseResourceCheck):
    def __init__(self) -> None:
        name = "Ensure resources are deployed only at allowed locations.(eastus2,centralus,westeurope,northeurope,southeastasia,eastasia,global,uksouth)"
        id = "CCOE_AZ2_16"
    ...
    def scan_resource_conf(self, conf: dict[str, list[Any]]) -> CheckResult:
        ...
        if resource_type:
            ...
            if location and isinstance(location, list):
                location = location[0]
                if location is not None and location in ["eastus2", "centralus", "westeurope", "northeurope", "southeastasia", "eastasia", "global", "uksouth", "EastUS2", "CentralUS", "NorthEurope", "WestEurope", "SoutheastAsia", "EastAsia"]:
